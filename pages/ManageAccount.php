        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="notification">
                                        <a href="#EditCat<?php echo $col['AccountId']; ?>" class=""
                                            data-toggle="modal"><span
                                                class="btn btn-primary btn-xs glyphicon glyphicon-edit"
                                                data-toggle="tooltip" data-placement="left" title=""
                                                data-original-title="<?php echo $EditAccount; ?>"></span></a>
                                        <a href="#DeleteCat<?php echo $col['AccountId']; ?>" data-toggle="modal"><span
                                                class=" glyphicon glyphicon-trash btn btn-primary btn-xs"
                                                data-toggle="tooltip" data-placement="right" title=""
                                                data-original-title="<?php echo $DeleteAccounts; ?>"></span></a>
                                    </td>
                                </tr>
                            </tbody>
                            <div class="modal fade" id="DeleteCat<?php echo $col['AccountId']; ?>" tabindex="-1"
                    ...
                    <!-- /.modal -->
                    <!-- /.edit category -->
                    <div class="modal fade" id="EditCat<?php echo $col['AccountId']; ?>" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" required name="categoryedit"
                                                value="<?php echo $col['AccountName']; ?>" type="text" autofocus>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
        ...
        <div class="modal-content">
            <form action="" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="category"><?php echo $Account; ?></label>
                        <input class="form-control" required placeholder="<?php echo $Account; ?>" name="account"
                            type="text" autofocus>
                    </div>
                </div>
                <div class="modal-footer">
