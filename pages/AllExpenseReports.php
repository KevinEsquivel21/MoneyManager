        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <p class="btn btn-primary"><?php echo $TotalExpenseToday; ?>
                        <?php echo $ColUser['Currency'] . ' ' . number_format($BillsOverall); ?></p><br /><br />
                    <p class="btn btn-warning"><?php echo $TotalExpenseThisMonth; ?>
                        <?php echo $ColUser['Currency'] . ' ' . number_format($BillThisMonth); ?></p><br /><br />
                    <p class="btn btn-info"><?php echo $TotalExpenseReport; ?>
                        <?php echo $ColUser['Currency'] . ' ' . number_format($BillToday); ?></p><br /><br />
                </div>
            </div>
        </div>
