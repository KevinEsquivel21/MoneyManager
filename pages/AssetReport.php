                                    ...
                                    <td colspan="2" class="notification">
                                        <a href="index.php?page=ManageIncome&id=<?php echo $col['AssetsId']; ?>"
                                            class="" data-toggle="modal"><span
                                                ...
                                                data-original-title="<?php echo $EditIncome; ?>"></span></a>
                                        <a href="#DeleteIncome<?php echo $col['AssetsId']; ?>" data-toggle="modal"><span
                                                class=" glyphicon glyphicon-trash btn btn-primary btn-xs"
                                                data-toggle="tooltip" data-placement="right" title=""
                                                data-original-title="<?php echo $DeleteIncomes; ?>"></span></button>
                                    </td>
                                </tr>
                            </tbody>
