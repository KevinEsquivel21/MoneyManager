                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="notification">
                                        <a href="index.php?page=ManageExpense&id=<?php echo $col['BillsId']; ?>"
                                            class="" data-toggle="modal"><span
                                                class="btn btn-primary btn-xs glyphicon glyphicon-edit"
                                                data-toggle="tooltip" data-placement="left" title=""
                                                data-original-title="<?php echo $EditExpense; ?>"></span></a>
                                        <a href="#DeleteEx<?php echo $col['BillsId']; ?>" data-toggle="modal"><span
                                                class=" glyphicon glyphicon-trash btn btn-primary btn-xs"
                                                data-toggle="tooltip" data-placement="right" title=""
                                                data-original-title="<?php echo $DeleteExpenses; ?>"></span></button>
                                    </td>
                                </tr>
                            </tbody>
                            <div class="modal fade" id="DeleteEx<?php echo $col['BillsId']; ?>" tabindex="-1"
                                    ...
                                    <div class="modal-content">
                                        <form action="" method="post">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="hidden" id="BillsId" name="BillsId"
                                                    value="<?php echo $col['BillsId']; ?>" />
