                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-12 text-left">
                            <h2><?php echo $ColUser['Currency'] . ' ' . number_format($ExpenseColDate['Amount']); ?>
                            </h2>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div>
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $ColUser['Currency'] . ' ' . number_format($col['Amount']); ?>
                                        </td>
                                    </tr>
                                    <?php }?>
                                </tbody>
                        ...
                        <div class="text-center"><a href="index.php?page=AssetReport"><?php echo $ViewDetails; ?></a>
                        </div>
                    </div>
                </div>
                <!-- /.panel-body -->
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $col['AccountName']; ?></td>
                                            <td class="text-right">
                                                <?php echo $ColUser['Currency'] . ' ' . number_format($col['Amount']); ?>
                                            </td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
    ...
    ?>
                            <div>
                                <p>
                                    ...
                                    <span class="pull-right text-muted"><?php echo $Budgetss; ?>
                                        <?php echo $ColUser['Currency'] . ' ' . number_format($BudgetCols['Amount']); ?></span>
                                </p>

                                <div class="text-right panel panel-yellow">
                                    <div class="panel-heading"><?php echo $Outs; ?>:
                                        <?php echo $ColUser['Currency'] . ' ' . number_format($Out); ?>
                                        <?php echo $RemainingBudget; ?>:
                                        <?php echo $ColUser['Currency'] . ' ' . number_format($BudgetCols['Totals']); ?>
                                    </div>
                                </div><br />
                            </div>
                            <?php }?>
            ...
            <div class="panel panel-red">
                ...
                <div class="panel-body">
                    <div class="row">
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $ColUser['Currency'] . ' ' . number_format($cols['Amount']); ?>
                                            </td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
                        ...
                        <div class="text-center"><a href="index.php?page=ExpenseReport"><?php echo $ViewDetails; ?></a>
                        </div>
                        <!-- /.col-lg-4 (nested) -->
