                        ...
                        <fieldset>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" required placeholder="<?php echo $Amount; ?>"
                                        value="<?php echo number_format($row['Amount']); ?>" id="iamount" name="iamount"
                                        type="text" value="">
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <select name="icategory" class="form-control">
                                    <option value="<?php echo $row['CategoryId']; ?>" select="selected">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select name="iaccount" class="form-control">
                                    <option value="<?php echo $row['AccountId']; ?>" select="selected">
                                        <?php echo $row['AccountName']; ?></option>
                                    <option value="" disabled>------------------</option>
                                    <?php while ($col = mysqli_fetch_assoc($AccountIncome)) {?>
                                    <option value="<?php echo $col['AccountId']; ?>"><?php echo $col['AccountName']; ?>
                                    </option>
                                    <?php }?>
                                </select>
                            </div>
