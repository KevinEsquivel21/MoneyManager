    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="panel panel-success ">
                ...
                <div class="panel-body">
                    <p class="btn btn-primary"><?php echo $ReportTotalIncome; ?>
                        <?php echo $ColUser['Currency'] . ' ' . number_format($IncomeOverall); ?></p><br /><br />
                    <p class="btn btn-warning"><?php echo $ReportTotalExpense; ?>
                        <?php echo $ColUser['Currency'] . ' ' . number_format($BillsOverall); ?></p>
                    <hr>
                    <p class="btn btn-danger"><?php echo $ReportIncomeExpense; ?>
                        <?php echo $ColUser['Currency'] . ' ' . number_format($IncomeOverall - $BillsOverall); ?> </p>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="panel panel-success ">
                ...
                <div class="panel-body">
                    <p class="btn btn-primary"><?php echo $ReportTotalIncome; ?>
                        <?php echo $ColUser['Currency'] . ' ' . number_format($IncomeThisMonth); ?></p><br /><br />
                    <p class="btn btn-warning"><?php echo $ReportTotalExpense; ?>
                        <?php echo $ColUser['Currency'] . ' ' . number_format($BillThisMonth); ?></p>
                    <hr>
                    <p class="btn btn-danger"><?php echo $ReportIncomeExpense; ?>
                        <?php echo $ColUser['Currency'] . ' ' . number_format($IncomeThisMonth - $BillThisMonth); ?>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="panel panel-success ">
                ...
                <div class="panel-body">
                    <p class="btn btn-primary"><?php echo $ReportTotalIncome; ?>
                        <?php echo $ColUser['Currency'] . ' ' . number_format($IncomeToday); ?></p><br /><br />
                    <p class="btn btn-warning"><?php echo $ReportTotalExpense; ?>
                        <?php echo $ColUser['Currency'] . ' ' . number_format($BillToday); ?></p>
                    <hr>
                    <p class="btn btn-danger"><?php echo $ReportIncomeExpense; ?>
                        <?php echo $ColUser['Currency'] . ' ' . number_format($IncomeToday - $BillToday); ?> </p>
                </div>
            </div>
        </div>
