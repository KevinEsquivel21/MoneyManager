    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-warning">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="assetsdata">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo date("F", strtotime($col['Dates'])) . ' ' . date("Y", strtotime($col['Dates'])); ?>
                                </td>

                                <td><?php echo $ColUser['Currency'] . ' ' . number_format($col['Amount']); ?></td>
                                <td colspan="2" class="notification">
                                    <a href="#EditBudget<?php echo $col['BudgetId']; ?>" class=""
                                        data-toggle="modal"><span
                                            class="btn btn-primary btn-xs glyphicon glyphicon-edit"
                                            data-toggle="tooltip" data-placement="left" title=""
                                            data-original-title="<?php echo $EditBudget; ?>"></span></a>
                                    <a href="#DeleteBudget<?php echo $col['BudgetId']; ?>" data-toggle="modal"><span
                                            class=" glyphicon glyphicon-trash btn btn-primary btn-xs"
                                            data-toggle="tooltip" data-placement="right" title=""
                                            data-original-title="<?php echo $DeleteBudgets; ?>"></span></button>
                                </td>
                            </tr>
                        </tbody>
                        <div class="modal fade" id="DeleteBudget<?php echo $col['BudgetId']; ?>" tabindex="-1"
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="hidden" id="budgetid" name="budgetid"
                                                value="<?php echo $col['BudgetId']; ?>" />
                                            <button type="input" id="submit" name="deletebudget"
                ...
                <!-- /.edit budget -->
                <div class="modal fade" id="EditBudget<?php echo $col['BudgetId']; ?>" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" required id="iamount" name="amountedit"
                                                type="text" value="<?php echo number_format($col['Amount']); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">

                                    <input type="hidden" id="budgetsids" name="budgetsids"
                                        value="<?php echo $col['BudgetId']; ?>" />
                                    <button type="input" id="submit" name="edit"
                                        class="btn btn-primary"><?php echo $Save; ?></button>
                                    <button type="button" class="btn btn-default"
                                        data-dismiss="modal"><?php echo $Cancel; ?></button>
                            </form>
                        </div>
        ...
        <div class="modal-content">
            <form action="" method="post">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><?php echo $BudgetFor; ?> <b><?php echo date("F Y"); ?>
                    </h4>
                </div>
                <div class="modal-body">
                    <fieldset>
                        <div class="form-group col-lg-6 ">
                            ...
                            <select name="category" class="form-control">
                                ...
                                <option value="<?php echo $col['CategoryId']; ?>"><?php echo $col['CategoryName']; ?>
                                </option>
                                <?php }?>
                            </select>
                        </div>
                        <div class="form-group col-lg-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><?php echo $ColUser['Currency']; ?></span>
                                <input class="form-control" required placeholder="<?php echo $Amount; ?>" id="iamount"
